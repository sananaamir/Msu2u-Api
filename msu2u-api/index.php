...
/**Anne add
 * This components controls the initialization of models, 
 *keeping record of relations between the different models of the application.
 */
...
/**
* Database setup.  Connecting to our mysql db
*/
// $di->set('db', function(){
